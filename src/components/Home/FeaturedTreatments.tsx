...
export const FeaturedTreatments: React.FC<FeaturedTreatmentsProps> = ({ onOpenBookingWithService }) => {
  ...
  // Filter or map 6 primary treatment categories as required
              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                ...
                <div className="pt-4 flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 bg-[#0B4F6C] hover:bg-[#083A50] text-white font-extrabold text-xs py-3.5 rounded-xl shadow transition-all duration-200 flex items-center justify-center space-x-1.5"
                  >
