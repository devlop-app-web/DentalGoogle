      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 flex items-center justify-between">
              ...
              {REVIEWS.map((_, idx) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all ${
                    activeReviewIndex === idx ? 'bg-[#0B4F6C] w-8' : 'bg-slate-300'
                  }`}
            ...
            <div className="flex items-center space-x-2">
              <button
                onClick={prevReview}
                id="review-prev-btn"
                className="p-2.5 rounded-xl bg-slate-100 text-slate-700 hover:bg-slate-200 transition-colors shadow-2xs"
              ...
              <button
                onClick={nextReview}
                id="review-next-btn"
                className="p-2.5 rounded-xl bg-[#0B4F6C] text-white hover:bg-[#083A50] transition-colors shadow-2xs"
        ...
        <div className="mt-10 text-center">
          <a
            ...
            className="inline-flex items-center space-x-2 bg-white hover:bg-slate-100 text-[#0B4F6C] border border-cyan-200 font-extrabold text-xs sm:text-sm px-6 py-3.5 rounded-xl shadow-2xs transition-all"
          >
