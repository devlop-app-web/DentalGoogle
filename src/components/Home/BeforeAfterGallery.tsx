...
import { Sparkles, Calendar, ArrowRight, ShieldCheck, Clock, Layers } from 'lucide-react';
...
export const BeforeAfterGallery: React.FC<BeforeAfterGalleryProps> = ({ onOpenBooking }) => {
  ...
  return (
    <section id="gallery" className="py-20 bg-slate-50 border-t border-slate-200/80 relative">
