...
export const TreatmentsSection: React.FC<TreatmentsSectionProps> = ({ onOpenBookingWithService }) => {
  ...
  return (
    <section id="treatments" className="py-20 bg-[#F8FAFC] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 bg-white rounded-3xl border border-slate-200/80 overflow-hidden shadow-lg grid grid-cols-1 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-5 h-64 lg:h-full min-h-[220px] relative overflow-hidden">
            <img 
              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                ...
                <div className="pt-4 flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 bg-[#0F6CBD] hover:bg-[#0B5598] text-white font-bold text-xs py-3 rounded-xl shadow-sm transition-all duration-200 flex items-center justify-center space-x-1"
                  >
                  ...
                  <button
                    ...
                    className="p-3 bg-slate-50 hover:bg-slate-100 text-slate-700 font-semibold rounded-xl border border-slate-200 transition-colors"
      ...
      {activeModalTreatment && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 sm:p-8 shadow-2xl relative border border-slate-200 max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
            <button
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 flex gap-3">
                <button
                  ...
                  className="w-full bg-[#0F6CBD] hover:bg-[#0B5598] text-white font-bold py-3.5 rounded-xl shadow-md text-sm flex items-center justify-center space-x-2"
                >
