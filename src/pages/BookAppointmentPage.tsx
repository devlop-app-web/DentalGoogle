          ...
          {isSubmitted ? (
            <div className="py-12 text-center space-y-4">
              ...
              <div className="pt-6">
                <Link
                  to="/"
                  className="bg-[#0F6CBD] hover:bg-[#0B5598] text-white font-bold text-sm px-6 py-3 rounded-xl shadow-md transition-all inline-block"
                >
                  Return to Home Page
                </Link>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      ...
                      className={`p-3.5 rounded-2xl border text-left transition-all text-xs font-semibold flex items-center justify-between ${
                        selectedService === service.id
                          ? 'border-[#0F6CBD] bg-blue-50/80 text-[#0F6CBD] font-bold shadow-sm'
                          : 'border-slate-200 hover:border-slate-300 text-slate-700 bg-slate-50'
                      }`}
                    >
                      <span>{service.title}</span>
                      {selectedService === service.id && <CheckCircle className="w-4 h-4 text-[#0F6CBD]" />}
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-xs font-medium text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#0F6CBD]"
                  />
                </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#0F6CBD] hover:bg-[#0B5598] text-white font-bold text-base py-4 rounded-xl shadow-lg transition-all flex items-center justify-center space-x-2"
              >
